export const huntRoutes = [
  {
    title: 'activities',
    slug: 'activities',
    intro: 'Physical games, weird tasks, riddles, hidden codes, direct interaction with volunteers, and a few extra movement based challenges now folded indoors.',
    stops: [
      ...
      { id: 'recreate-resistance', title: 'recreate resistance', clue: 'Somewhere in the event space, recreate an iconic image of resistance with your body, your crew, or what you can find nearby.', answerPrompt: 'Take a photo, post it with the event hashtag, and show the photo to a volunteer.', hint: 'Raised fists, chain breakers, protest signs, arm in arm. Start there.', completionType: 'volunteer' },
      { id: 'maypole-riddle', title: 'maypole riddle', clue: 'Solve the riddle about the pole wrapped in bold ribbons and rooted in celebration.', answerPrompt: 'What am I?', hint: 'It rises once a year and dances without feet.', completionType: 'password' },
      { id: 'ribbon-thread', title: 'ribbon thread', clue: 'At the maypole or ribbon display, find the red thread tied to a ribbon or stake and follow it through the venue.', answerPrompt: 'Find the hidden pouch or envelope waiting at the end.', hint: 'It may loop, double back, or slip under benches.', completionType: 'onsite-only' },
  ...
  },
  {
    title: 'vendors',
    slug: 'vendors',
    intro: 'Vendor stalls, radical literature, riddles, trades, hidden objects, a classified detour, and a few extra puzzle stops folded into the vendor zone.',
    stops: [
      ...
      { id: 'cassette-player', title: 'cassette player', clue: 'Find the old school cassette player hidden somewhere in the event space and listen to the queued message.', answerPrompt: 'Follow the spoken riddle about looking through the glass and reading what cannot be read.', hint: 'It is where people sit but do not stay long, between food and shade.', completionType: 'onsite-only' },
  ...
  },
  {
    title: 'indoors',
    slug: 'indoors',
    intro: 'Museum displays, labor history, perspective puzzles, hidden threads, riddles, poetry, and the deeper indoor ARG trail.',
    stops: [
      ...
      { id: 'poem-mic', title: 'poem at the mic', clue: 'Write a poem about labor, resistance, identity, grief, hope, rage, home, or whatever burns in your chest.', answerPrompt: 'Read it aloud or hand it to a volunteer, then receive the clue that carries you into the next challenge.', hint: 'It does not have to rhyme. It just has to be yours.', completionType: 'volunteer' },
      { id: 'venue-perspective', title: 'venue perspective match', clue: 'Match the ordinary looking venue photo with the real place and exact camera angle somewhere in the building or shared indoor space.', answerPrompt: 'Stand in the correct location to reveal the hidden QR code.', hint: 'Corners, posts, bulletin boards, stair edges, and strange little details all matter here.', completionType: 'onsite-only' },
      { id: 'station-mayday', title: 'station mayday', clue: 'Find the soft low power FM signal or posted audio clue somewhere near the edges of the venue and listen to the broadcast.', answerPrompt: 'Use the radio message to begin collecting the broken QR code pieces scattered through the venue.', hint: 'The message starts with “This is Station MAYDAY.”', completionType: 'onsite-only' },
      { id: 'broken-qr', title: 'broken qr code', clue: 'Find the scattered QR pieces hidden beneath, behind, hanging, or left in plain sight around the venue.', answerPrompt: 'Assemble the pieces until the code makes sense.', hint: 'The broadcast says the pieces do not wait forever.', completionType: 'onsite-only' },
    ],
  },
]
