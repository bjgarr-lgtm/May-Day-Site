...
function SectionTitle({ eyebrow, title, body }) {
  return (
    <div className="max-w-3xl space-y-3">
      ...
      <h2 className="text-2xl font-black uppercase tracking-tight text-[#f2c4cf] sm:text-3xl lg:text-4xl">{title}</h2>
...
function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#f2c4cf]/15 bg-[#163a2d]/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <button
          type="button"
          onClick={() => scrollToSection('top')}
          className="max-w-[13rem] text-left text-xs font-black uppercase leading-tight tracking-[0.14em] text-[#f2c4cf] sm:max-w-[15rem] sm:text-sm"
        >
        ...
        <button
          type="button"
          className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#f2c4cf]/20 text-[#f7f1e8] md:hidden"
        ...
        <div className="border-t border-[#f2c4cf]/10 px-4 py-4 md:hidden">
          <div className="flex flex-col gap-2">
            ...
            <Link
              ...
              className="rounded-2xl border border-[#f2c4cf]/15 px-4 py-3 text-sm font-semibold text-[#f7f1e8]/88"
            >
              Hunt Routes
            </Link>
          </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 sm:py-16 lg:grid-cols-[1.1fr_.9fr] lg:px-8 lg:py-20">
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.9] tracking-tight text-[#f2c4cf] sm:text-6xl lg:text-8xl">
              may day
          ...
          <div className="flex flex-wrap gap-2 text-xs font-semibold uppercase tracking-[0.14em] sm:gap-3 sm:text-sm sm:tracking-[0.16em]">
            {[siteMeta.dateLabel, siteMeta.hoursLabel, siteMeta.freeLabel].map((item) => (
              <span key={item} className="rounded-full border border-[#f2c4cf]/25 bg-[#f2c4cf]/10 px-3 py-2 text-[#f7f1e8] sm:px-4">
                {item}
              </span>
            ))}
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            {quickLinks.map((item) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() => scrollToSection(item.id)}
                  className="inline-flex h-auto min-h-11 items-center rounded-full bg-[#f2c4cf] px-4 py-3 text-xs font-black uppercase tracking-[0.14em] text-[#153227] transition hover:bg-[#ffd8e1] sm:px-5 sm:text-sm sm:tracking-[0.15em]"
                >
            ...
            <Link to="/hunt">
              <button
                type="button"
                className="inline-flex h-auto min-h-11 items-center rounded-full border border-[#f2c4cf]/25 bg-black/20 px-4 py-3 text-xs font-black uppercase tracking-[0.14em] text-[#f7f1e8] transition hover:bg-[#f2c4cf]/10 sm:px-5 sm:text-sm sm:tracking-[0.15em]"
              >
        ...
        {infoCards.map((card) => {
          ...
          return (
            <div key={card.title} className="rounded-[2rem] border border-[#f2c4cf]/20 bg-black/20 p-6">
              <div className="mb-4 inline-flex rounded-2xl border border-[#f2c4cf]/20 bg-[#f2c4cf]/10 p-3 text-[#f2c4cf]">
              ...
              {card.title === 'why may day' && siteMeta.laborHistoryHref ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-5 inline-flex items-center rounded-full border border-[#f2c4cf]/20 bg-[#f2c4cf]/10 px-4 py-2 text-sm font-black uppercase tracking-[0.14em] text-[#f7f1e8] transition hover:bg-[#f2c4cf]/15"
                >
          ...
          {filters.map((item) => (
            <button
              ...
              className={`rounded-full border px-4 py-2 text-sm font-bold uppercase tracking-[0.14em] transition ${
                filter === item
                  ? 'border-[#f2c4cf] bg-[#f2c4cf] text-[#153227]'
                  : 'border-[#f2c4cf]/20 bg-[#f2c4cf]/5 text-[#f7f1e8]/82 hover:bg-[#f2c4cf]/10'
              }`}
            >
              {item}
            </button>
        ...
        <div className="grid gap-8 lg:grid-cols-[.95fr_1.05fr]">
          <div className="space-y-6">
            ...
            <div className="rounded-[2rem] border border-[#f2c4cf]/20 bg-[#163126]/65 p-6">
              ...
              <Link
                to="/hunt"
                className="mt-5 inline-flex rounded-full border border-[#f2c4cf]/20 bg-[#f2c4cf]/10 px-5 py-3 text-sm font-black uppercase tracking-[0.14em] text-[#f7f1e8] transition hover:bg-[#f2c4cf]/15"
              >
                open hunt routes
              </Link>
            </div>
            ...
            <div className="mt-5 flex flex-col gap-3">
              {siteMeta.donateHref ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#f2c4cf] px-5 py-3 text-center text-sm font-black uppercase tracking-[0.14em] text-[#153227] transition hover:bg-[#ffd8e1]"
                >
                  <HandCoins className="mr-2 h-4 w-4 shrink-0" />
                  donate
                </a>
              ...
              {siteMeta.shopHref ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-12 items-center justify-center rounded-full border border-[#f2c4cf]/20 bg-black/15 px-5 py-3 text-center text-sm font-black uppercase tracking-[0.14em] text-[#f7f1e8] transition hover:bg-[#f2c4cf]/10"
                >
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                {siteMeta.facebookHref ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-[#f2c4cf]/20 bg-black/15 text-[#f7f1e8] transition hover:bg-[#f2c4cf]/10"
                    aria-label="Facebook"
                  >
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <a href={siteMeta.shopHref} target="_blank" rel="noreferrer">
            <button
              type="button"
              className="inline-flex h-auto min-h-12 items-center rounded-full bg-[#f2c4cf] px-6 py-3 text-sm font-black uppercase tracking-[0.14em] text-[#153227] transition hover:bg-[#ffd8e1]"
            >
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {merchItems.map((item) => (
            <div key={item.title} className="rounded-[2rem] border border-[#f2c4cf]/20 bg-[#11261e] p-5">
              ...
              <a href={siteMeta.shopHref} target="_blank" rel="noreferrer" className="mt-5 inline-flex items-center gap-2 text-sm font-black uppercase tracking-[0.14em] text-[#f2c4cf]">
